        ...
        <div class="form-card-container">
            <div class="card-custom p-4 p-md-4">
                <div class="d-flex align-items-center gap-3 mb-4 pb-3 border-bottom">
                    ...
                    <div>
                        <h1 class="h5 fw-bold text-dark mb-0">Tambah Produk</h1>
                        <p class="text-muted small mb-0">Masukkan nama produk baru yang Anda jual</p>
                    </div>
                </div>
                ...
                <form action="<?= site_url('products/store') ?>" method="post">
                    ...
                    <div class="mb-4">
                        <label for="name" class="form-label fw-semibold text-dark small">Nama Produk <span class="text-danger">*</span></label>
                        <div class="input-group">
                            ...
                            <input
                                ...
                                name="name"
                                value="<?= old('name') ?>"
                                placeholder="Contoh: Kopi Aren, Keripik Singkong"
                                autocomplete="off"
                                required
                                autofocus>
                        </div>
